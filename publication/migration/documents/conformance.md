...
- Planned canonical path: `drafts/modules/conformance.md`

## Exact Normative Dependencies

- `https://github.com/0al-spec/agent-surface/documents/core` at `0.1.0-draft.1` (candidate `publication/migration/documents/core.md`)
- `https://github.com/0al-spec/agent-surface/documents/authorization` at `0.1.0-draft.1` (candidate `publication/migration/documents/authorization.md`)
- `https://github.com/0al-spec/agent-surface/documents/safe-effects` at `0.1.0-draft.1` (candidate `publication/migration/documents/safe-effects.md`)
- `https://github.com/0al-spec/agent-surface/documents/evidence` at `0.1.0-draft.1` (candidate `publication/migration/documents/evidence.md`)
- `https://github.com/0al-spec/agent-surface/documents/privacy` at `0.1.0-draft.1` (candidate `publication/migration/documents/privacy.md`)
- `https://github.com/0al-spec/agent-surface/documents/bindings/asp-over-mcp` at `0.1.0-draft.1` (candidate `publication/migration/documents/bindings/asp-over-mcp.md`)
