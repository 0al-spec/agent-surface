...
[Host-Provisioned Bearer Authentication Descriptor](core.md#host-provisioned-bearer-authentication-descriptor).
...
in [Grant Credentials and Proof](authorization.md#grant-credentials-and-proof).
...
The issuer MUST derive the complete existing [Grant Object](authorization.md#grant-object)
...
[Grant Hash](authorization.md#grant-hash) hashing view for the Grant lifetime
...
[Semantic Grant Revocation Transition](authorization.md#semantic-grant-revocation-transition),
including every credential, applicable lineage member, and the concurrency
fence in [Revocation Timing and Concurrency](authorization.md#revocation-timing-and-concurrency),
...
[Active Grant Management](authorization.md#active-grant-management). The
...
[Session Authority and Lifecycle](authorization.md#session-authority-and-lifecycle)
