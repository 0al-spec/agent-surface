...
qualification cases still need dedicated transport/state implementations and
vectors; existing suite success does not establish support for that binding.
